...
class Simulated_Race_Manager:
    ...
    def runSimulatedRaces(self,driver1,driver2):
        ...
        for circuit in currentCircuits:
            ...
            driver2RaceData = theDatabaseManager.getRaceData(circuit,driver2)
            ...
            if (len(driver1RaceData) != 0 ) and (len(driver2RaceData) != 0):
                ...
                drviver1YearComp = theDatabaseManager.getYearComp(driver1BestRaceYear)
                ...
                drviver2YearComp = theDatabaseManager.getYearComp(driver2BestRaceYear)
                ...
                raceDataDictionary = {"circuit": circuit,
                                      ...
                                      "Driver 1 Best Time after Comp": driver1BestTimeAfterComp,
                                      "Race Winner afte Comp": raceWinner
                                      }
...
theSimulatedRaceManager.runSimulatedRaces("Michael Schumacher","Lewis Hamilton")
